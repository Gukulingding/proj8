...
namespace WebApplication7.Models
{
    public class Class1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,name,age,username,password")] Class1 class1)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,name,age,username,password")] Class1 class1)
        {
            if (ModelState.IsValid)
            {
